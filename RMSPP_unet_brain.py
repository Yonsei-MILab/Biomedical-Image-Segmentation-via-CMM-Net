...
def pool_block(feats, pool_factor):
	...
	x = Conv2D(64, (1, 1), data_format=IMAGE_ORDERING, padding='same', use_bias=False)(x)
...
def RMSPP_unet_brain(n_classes, input_height=192, input_width=256):
	...
	pool_factors = [1, 4, 16, 48]#[1, 4, 8]#[1, 2, 4, 8]
	pool_outs = [conv1]
	...
	model.model_name = "RMSPP_unet_brain"
